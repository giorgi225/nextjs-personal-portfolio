...
const Sidebar = ({ isActive, closeSidebar }: SidebarProps) => {
  ...
  return (
    <aside
      className={`${sidebarToggleClassname()} select-none z-[99999999] bottom-0 bg-grayLight overflow-auto w-full fixed pt-2 md:pt-0 h-max md:h-full lg:shadow-none lg:relative lg:left-0 md:min-w-[260px] md:max-w-[260px] px-1 pr-0 transition-all`}
    >
